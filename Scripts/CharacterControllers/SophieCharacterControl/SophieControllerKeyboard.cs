...
/// <para>Last modified: 26/10/2012 18:50</para> 
/// <para>Author: Marcos Zalacain </para>
/// SophieControllerKeyboard:   
///    -This script is to control Sophie with Keyboard.
/// </summary>
public class SophieControllerKeyboard : MonoBehaviour {
	...
	{	
		// .............................SHOOTING ........................................
		if (Input.GetKey (KeyCode.F) && canControl) {
			ApplyShooting();
		}
		if(canShootArrow){
...
// Various helper functions below:
	...
	// Throws player back when she hits something bad.
	...
	void actualShoot(){
		...
		lauchedArrow = Instantiate(arrow, arrowLaunchingPosition.position, arrowLaunchingPosition.rotation) as GameObject;
		if (movement.direction.x > 0) {
